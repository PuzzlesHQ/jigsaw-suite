        ...
        project.getConfigurations().all(configuration -> { // I have to do this so it doesn't crash when it can't find it
            if (configuration.getName().equals(configurationNameInternal)) {
                ...
                for (ResolvedArtifact resolvedArtifact : resolvedArtifacts) {
                    ...
                    if ("server".equals(classifier)) {
                        serverIn.set(resolvedArtifact.getFile());
                        continue;
                    }

                    if ("client".equals(classifier)) {
...
//                        dependencyHandler.add(commonImpl.getName(),  dependencyName + ":client");
//                        continue;
//                    }
//
//                    if (JigsawGame.IS_SPLIT) {
//                        assert clientImpl != null;
//                        dependencyHandler.add(clientImpl.getName(), dependencyName + ":client");
//                        assert commonImpl != null;
//                        dependencyHandler.add(commonImpl.getName(), dependencyName + ":server");
//                        assert serverImpl != null;
//                        dependencyHandler.add(serverImpl.getName(), dependencyName + ":server");
//                        continue;
//                    }
//
